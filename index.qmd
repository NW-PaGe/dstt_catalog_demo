...
# ui code insert during GitHub Actions workflow
source('src/ui.R') # insert ui_code here

# server code insert during GitHub Actions workflow
source('src/sever.R') # insert server_code here
